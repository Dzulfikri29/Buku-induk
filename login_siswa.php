...
if (isset($_POST['login'])) {
    ...
    $result=mysqli_query($db, "SELECT * FROM user WHERE username ='".$username."' and pass='".md5($pass)."'");
    ...
    if ($row=mysqli_fetch_array($result)) {
        ...
        <script type='text/javascript'>
         ...
         window.setTimeout(function(){ 
          window.location.replace('tampil_data.php');
         } ,3000); 
        </script>";
    }else{
        echo "
            ...
            <div class="hero-body">
                <div class="container has-text-centered">
                    <div class="column is-4 is-offset-4">
                        ...
                        <p class="subtitle has-text-white">Siswa | SMK Coding</p>
                        <div class="box">
                            <figure class="avatar">
                            ...
                            <form action="<?php $_SERVER['PHP_SELF']?>" method="POST">
                                ...
                                <p class="help is-danger"><?php if(isset($err_msg)) echo $err_msg;?></p>
                            </form><br>
                            <p>Belum mendaftar? <a href="register_user.php">Daftar disini!</a></p>
                        </div>
                    </div>
                </div>
            </div>
